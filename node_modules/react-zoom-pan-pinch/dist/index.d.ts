...
declare const zoomIn: (contextInstance: ReactZoomPanPinchContext) => (step?: number, animationTime?: number, animationType?: keyof typeof animations) => Promise<void>;
declare const zoomOut: (contextInstance: ReactZoomPanPinchContext) => (step?: number, animationTime?: number, animationType?: keyof typeof animations) => Promise<void>;
declare const setTransform: (contextInstance: ReactZoomPanPinchContext) => (newPositionX: number, newPositionY: number, newScale: number, animationTime?: number, animationType?: keyof typeof animations) => Promise<void>;
declare const resetTransform: (contextInstance: ReactZoomPanPinchContext) => (animationTime?: number, animationType?: keyof typeof animations) => Promise<void>;
declare const centerView: (contextInstance: ReactZoomPanPinchContext) => (scale?: number, animationTime?: number, animationType?: keyof typeof animations) => Promise<void>;
/**
 ...
 * (#353).
 */
declare const zoomToPoint: (contextInstance: ReactZoomPanPinchContext) => (scale: number, clientX: number, clientY: number, animationTime?: number, animationType?: keyof typeof animations) => Promise<void>;
/**
 ...
 */
declare const clientToContent: (contextInstance: ReactZoomPanPinchContext) => (clientX: number, clientY: number) => PositionType;
/**
 ...
 */
declare const contentToClient: (contextInstance: ReactZoomPanPinchContext) => (x: number, y: number) => PositionType;
/**
 ...
 */
declare const zoomToElement: (contextInstance: ReactZoomPanPinchContext) => (node: ZoomToElementTarget | ZoomToElementTarget[], scaleOrOptions?: number | ZoomToElementOptions, animationTime?: number, animationType?: keyof typeof animations, offsetX?: number, offsetY?: number) => Promise<void>;
/**
 ...
 */
declare const fitToView: (contextInstance: ReactZoomPanPinchContext) => (options?: FitToViewOptions) => Promise<void>;
/**
 ...
 */
declare const panBy: (contextInstance: ReactZoomPanPinchContext) => (deltaX: number, deltaY: number, animationTime?: number, animationType?: keyof typeof animations) => Promise<void>;

type MeasuredSizesType = {
    wrapperWidth: number;
...
declare class ZoomPanPinch {
    ...
    animationResolve: (() => void) | null;
    initObserverTimer: ReturnType<typeof setTimeout> | null;
    isInitialLayoutPending: boolean;
    measuredSizes: MeasuredSizesType | null;
    isResizeAlignmentPending: boolean;
    resizeAnimation: AnimationType | null;
    pressedKeys: {
        [key: string]: boolean;
    };
    selectionLock: {
    ...
    observeSizes: (wrapperComponent: HTMLDivElement, contentComponent: HTMLDivElement) => void;
    onSizeChange: () => void;
...
type ZoomToElementTarget = HTMLElement | string;
type ZoomToElementOptions = {
...
type FitToViewMode = "contain" | "cover";
type FitToViewOptions = {
...
declare const useZoomPanPinch: (props?: ReactZoomPanPinchProps) => {
...
export { type AnimationType, type BoundsType, Context, DeviceType, type FitToViewMode, type FitToViewOptions, KeepScale, type LibrarySetup, MiniMap, type MiniMapProps, type PositionType, type ReactZoomPanPinchBaseClasses, type ReactZoomPanPinchComponentHelpers, type ReactZoomPanPinchContentRef, type ReactZoomPanPinchContext, type ReactZoomPanPinchContextState, type ReactZoomPanPinchHandlers, type ReactZoomPanPinchProps, type ReactZoomPanPinchRef, type ReactZoomPanPinchRefProps, type ReactZoomPanPinchState, type SizeType, type StateType, TransformComponent, TransformWrapper, type VelocityType, Virtualize, type VirtualizeProps, type ZoomToElementOptions, type ZoomToElementTarget, getCenterPosition, getMatrixTransformStyles, getTransformStyles, roundScaleForTransform, useControls, useTransformComponent, useTransformContext, useTransformEffect, useTransformInit, useZoomPanPinch };
